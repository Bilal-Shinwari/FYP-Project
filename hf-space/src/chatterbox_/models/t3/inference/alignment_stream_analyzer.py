...
class AlignmentStreamAnalyzer:
    ...
    def step(self, logits, next_token=None):
        ...
        # Check for excessive token repetition (4x same token in a row, after 30 steps)
        # 2x threshold was too aggressive — Urdu phonemes legitimately repeat consecutive tokens.
        token_repetition = (
            self.curr_frame_pos >= 30 and
